...
export const StorageFxArea: FC = () => {
  ...
  return (
    <div className="bg-[#353535] shadow-[0_0_10px_rgba(20,20,20,0.5)] inset-shadow-[0_0_20px_rgba(20,20,20,0.3)] rounded-2xl h-full col-span-7 flex flex-row overflow-x-auto overflow-y-hidden [&::-webkit-scrollbar]:bg-transparent [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-thumb]:bg-[#757575] [&::-webkit-scrollbar-thumb]:rounded-lg gap-1 px-1">
      <BundleCard_Blank />
