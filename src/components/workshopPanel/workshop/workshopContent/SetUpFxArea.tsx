...
export const SetUpFxArea: FC = () => {
  return (
    <div className="bg-[#353535] shadow-[0_0_10px_rgba(20,20,20,0.5)] inset-shadow-[0_0_10px_rgba(20,20,20,0.2)] overflow-hidden rounded-2xl h-full flex flex-row col-span-4 pl-2 gap-x-2 pr-1 py-2">
